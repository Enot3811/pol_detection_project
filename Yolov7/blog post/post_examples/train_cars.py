...
class CarsDatasetAdaptor(Dataset):
    def __init__(
        ...
        self.image_idx_to_image_id = {
            ...
            for idx, image_id in enumerate(
                self.annotations_df.image_id.unique())
        }
    ...
    def __getitem__(self, index):
        ...
        image_info = self.annotations_df[
            self.annotations_df.image_id == image_id]
...
def main(
    ...
    train_df, valid_df, lookups = load_cars_df(annotations_file_path,
                                               images_path)
    num_classes = 1
